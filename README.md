# oneclick free vpn - corresponding source

This repository contains the source and build scripts corresponding to
`oneclick free vpn` for Android, package `com.oneclickvpn.tv`, version `1.0.0`
(`versionCode 34`).
...
Build the TV release bundle and run Lint:

```sh
cd android_tv_app
./gradlew --no-daemon :app:bundleTvRelease :app:lintTvRelease
```

...
`The app contains no ads and no analytics SDK. It uses Google Play Billing only for the optional Pro unlock. If billing is not available in the review environment, the free automatic VPN connection flow remains testable.`

`The app is not an official app of any public volunteer VPN server project and does not claim guaranteed anonymity, guaranteed security, guaranteed speed, or streaming-service access.`
